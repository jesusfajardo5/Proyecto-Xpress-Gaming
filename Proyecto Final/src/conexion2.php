...
$fabricante = $_POST['fabricante']; // Obtener el apellido paterno del formulario.
$estado = $_POST['estado']; // Obtener el apellido materno del formulario.
$no_controles = $_POST['no_controles']; // Obtener la edad del formulario.
$precio_renta = $_POST['precio_renta']; // Obtener la materia del formulario.

// Insertar los datos en la base de datos
$sql = "INSERT INTO consolas (id_consola, nombre, fabricante, estado, no_controles, precio_renta)
        VALUES ('$id_consola', '$nombre', '$fabricante', '$estado', '$no_controles', '$precio_renta')";
