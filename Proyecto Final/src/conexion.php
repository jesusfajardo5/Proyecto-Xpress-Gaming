...
$id_administrador = $_POST['id_administrador']; // Obtener el número de cuenta del formulario.
...
$fecha_registro = $_POST['fecha_registro']; // Obtener la edad del formulario.
$contrasena = $_POST['contrasena']; // Obtener la materia del formulario.

// Insertar los datos en la base de datos
$sql = "INSERT INTO administradores (id_administrador, nombre, email, telefono, fecha_registro, contrasena)
        VALUES ('$id_administrador', '$nombre', '$email', '$telefono', '$fecha_registro', '$contrasena')";
